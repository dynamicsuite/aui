...
Vue.component("aui-crud",{template:`<div class="aui crud"><aui-notice v-if="error" type="failure" :icon="error_icon" :text="error_text" :subtext="error_subtext"/><aui-notice v-else-if="created" type="success" :icon="form_created_confirmation_icon" :text="form_created_confirmation_text"/><aui-notice v-else-if="form_loading && overlay" :icon="form_loading_icon" :text="form_loading_text"/><aui-crud-list v-else-if="!show_form && !setup" ref="list" :title="list_title" :show_create="list_show_create" :create_icon="list_create_icon" :show_filter="list_show_filter" :filter_placeholder="list_filter_placeholder" :no_data_icon="list_no_data_icon" :no_data_text="list_no_data_text" :loading_icon="list_loading_icon" :loading_text="list_loading_text" :calling="calling" :overlay="overlay" :type="list_type" :storable_key="storable_key" :group_icon_key="list_group_icon_key" :group_title_key="list_group_title_key" :group_subtext_key="list_group_subtext_key" :table_default_columns="list_table_default_columns" :table_column_names="list_table_column_names" :table_column_format="list_table_column_format" :table_row_classes="list_table_row_classes" :table_storage_key="list_table_storage_key" :read_api="list_read_api" :read_optional_data="list_read_optional_data" :range_limit="list_range_limit" :filter_delay="list_filter_delay" :refresh_interval="list_refresh_interval" :get_key_limit="list_get_key_limit" :get_key_page="list_get_key_page" :get_key_filter="list_get_key_filter" :get_key_sort="list_get_key_sort" @update:calling="$emit('update:calling', $event)" @error="handleError" @show-create="handleFormCreate" @list-interaction="handleListInteraction"><template #actions><slot name="list-actions" :overlay="overlay"/></template><template #pre-data><slot name="list-pre-data" :overlay="overlay"/></template></aui-crud-list><div v-else-if="!setup" class="form"><slot name="form" :overlay="overlay"/><div v-if="!form_loading" class="actions"><slot name="form-back-button" :overlay="overlay"><aui-button v-if="form_show_back_button" type="secondary" :disabled="overlay" :text="form_action_back_text" @click="runBack"/></slot><div v-if="!form_for_create && form_update_api && !form_loading" class="action"><slot name="form-action-context"/><i v-if="show_tick" :class="tick_classes"/><slot name="form-update-button" :overlay="overlay"><div class="btn-group"><aui-button :text="form_action_update_text" :loading="overlay" :loading_text="form_action_update_loading_text" @click="runUpdate"/><aui-button-drop v-if="form_delete_api" relative_to=".form" :disabled="overlay" :dropdown="{delete: this.form_action_delete_text}" @delete="promptDelete"/></div></slot></div><div v-if="form_for_create && form_create_api && !form_loading" class="action"><slot name="form-action-context"/><slot name="form-create-button" :overlay="overlay"><aui-button :text="form_action_create_text" :loading="overlay" :loading_text="form_action_create_loading_text" @click="runCreate"/></slot></div></div></div><aui-modal type="failure" :title="form_action_delete_title" :show.sync="show_delete_modal"><template #content><slot name="delete-prompt"><p>{{form_action_delete_prompt}}</p></slot><aui-input label="Type DELETE to confirm" class="delete-confirm-input" v-model="delete_confirm"/><aui-alert v-if="delete_protect" type="failure" :text="delete_protect"/></template><template #left><aui-button type="secondary" :disabled="overlay" :text="form_action_delete_cancel_text" @click="runCancelDelete"/></template><template #right><aui-button type="failure" :disabled="!delete_confirmed" :loading="overlay" :loading_text="form_action_delete_loading_text" :text="form_action_delete_text" @click="runDelete"/></template></aui-modal></div>`,props:{error_icon:{type:String,default:"fas fa-exclamation-triangle"},error_text:{type:String,default:"A server error has occurred"},error_subtext:{type:String,default:"Please reload the page"},storable_key:{type:String,default:"id"},get_key_id:{type:String,default:"crud"},calling:{type:Boolean,default:!1},list_custom_interaction:{type:Boolean,default:!1},list_title:{type:String,default:"CRUD List"},list_show_create:{type:Boolean,default:!0},list_create_icon:{type:String,default:"fas fa-plus"},list_show_filter:{type:Boolean,default:!0},list_filter_placeholder:{type:String,default:"Filter"},list_no_data_icon:{type:String,default:"fas fa-ban"},list_no_data_text:{type:String,default:"No data"},list_loading_icon:{type:String,default:"fas fa-circle-notch fa-spin"},list_loading_text:{type:null|String,default:"Loading..."},list_type:{type:String,default:"table",validator:t=>-1!==["group","table"].indexOf(t)},list_group_icon_key:{type:String,default:"icon"},list_group_title_key:{type:String,default:"title"},list_group_subtext_key:{type:String,default:"subtext"},list_table_default_columns:{type:Array,default:()=>[]},list_table_column_names:{type:Object,default:()=>({})},list_table_column_format:{type:Object,default:()=>({})},list_table_row_classes:{type:Function,default:()=>({})},list_table_storage_key:{type:null|String,default:null},list_read_api:{type:String,required:!0},list_read_optional_data:{type:Object,default:()=>({})},list_range_limit:{type:Array,default:()=>[15,25,100]},list_filter_delay:{type:Number,default:300},list_refresh_interval:{type:null|Number,default:null},list_get_key_limit:{type:String,default:"limit"},list_get_key_page:{type:String,default:"page"},list_get_key_filter:{type:String,default:"filter"},list_get_key_sort:{type:String,default:"sort"},form:{type:Object,default:()=>({})},form_secure_fields:{type:Array,default:()=>[]},feedback:{type:Object,default:()=>({})},form_loading_icon:{type:String,default:"fas fa-circle-notch fa-spin"},form_loading_text:{type:null|String,default:"Loading..."},form_create_setup_api:{type:null|String,default:null},form_create_setup_api_data:{type:Object,default:()=>({})},form_create_api:{type:null|String,default:null},form_create_api_data:{type:Object,default:()=>({})},form_read_api:{type:null|String,default:null},form_read_api_data:{type:Object,default:()=>({})},form_update_api:{type:null|String,default:null},form_update_api_data:{type:Object,default:()=>({})},form_delete_api:{type:null|String,default:null},form_delete_api_data:{type:Object,default:()=>({})},form_exclude_columns:{type:Array,default:()=>[]},form_format_columns:{type:Object,default:()=>({})},form_show_actions:{type:Boolean,default:!0},form_show_back_button:{type:Boolean,default:!0},form_action_back_text:{type:String,default:"Back"},form_action_update_text:{type:String,default:"Update"},form_action_update_loading_text:{type:String,default:"Updating..."},form_action_create_text:{type:String,default:"Create"},form_action_create_loading_text:{type:String,default:"Creating..."},form_created_confirmation_icon:{type:String,default:"fas fa-check-circle"},form_created_confirmation_text:{type:String,default:"Created!"},form_action_delete_cancel_text:{type:String,default:"Cancel"},form_action_delete_text:{type:String,default:"Delete"},form_action_delete_loading_text:{type:String,default:"Deleting..."},form_action_delete_title:{type:String,default:"Confirm Delete"},form_action_delete_prompt:{type:String,default:"Are you sure you want to delete?"},form_feedback_success_tick_icon:{type:String,default:"fas fa-check"},form_feedback_failure_tick_icon:{type:String,default:"fas fa-times"},form_created_to_list:{type:Boolean,default:!0}},data(){return{default_form:{},setup:!0,show_form:!1,form_loading:!1,error:!1,created:!1,overlay:!1,show_delete_modal:!1,delete_confirm:null,delete_protect:null,show_success_tick:!1,show_failure_tick:!1}},computed:{form_for_create(){return!this.form[this.storable_key]},delete_confirmed(){return"DELETE"===this.delete_confirm},show_tick(){return this.show_success_tick||this.show_failure_tick},tick_classes(){return{"feedback-tick":!0,[this.form_feedback_success_tick_icon]:this.show_success_tick,[this.form_feedback_failure_tick_icon]:this.show_failure_tick}},api_form(){const t=JSON.parse(JSON.stringify(this.form));for(const e in t)-1===this.form_exclude_columns.indexOf(e)?this.form_format_columns.hasOwnProperty(e)&&"function"==typeof this.form_format_columns[e]&&(t[e]=this.form_format_columns[e](t[e])):delete t[e];return t}},watch:{calling:function(t){t?setTimeout(()=>{this.calling&&(this.overlay=!0)},100):this.overlay=!1}},methods:{resetForm(){this.$emit("update:form",this.default_form)},secureForm(){const t=JSON.parse(JSON.stringify(this.form));for(const e of this.form_secure_fields)t.hasOwnProperty(e)&&(t[e]=null);this.$emit("update:form",t)},resetFeedback(){const t=JSON.parse(JSON.stringify(this.feedback));for(const e in t)t[e]=null;this.show_success_tick=!1,this.show_failure_tick=!1,this.$emit("update:feedback",t)},readStorable(t){this.$emit("form-pre-read",!0);t=Object.assign({[this.storable_key]:t},this.form_read_api_data);DynamicSuite.call(this.form_read_api,t,t=>{switch(t.status){case"OK":if("object"!=typeof t.data){this.error=!0;break}const e=JSON.parse(JSON.stringify(this.form));for(const a in t.data)e.hasOwnProperty(a)&&(e[a]=t.data[a]);this.show_form=!0,this.form_loading=!1,this.setup=!1,this.$emit("update:form",e),this.$emit("update:calling",!1);break;case"NOT_FOUND":DynamicSuite.replaceURLHistory(this.get_key_id,null),location.reload();break;default:this.error=!0}})},handleError(){DynamicSuite.replaceURLHistory(this.get_key_id,null),this.error=!0},handleFormCreate(){DynamicSuite.pushURLHistory(this.get_key_id,0),this.runCreateSetup()},handleListInteraction(t){this.list_custom_interaction?this.$emit("list-interaction",t):(this.setup||DynamicSuite.pushURLHistory(this.get_key_id,t),this.handleFormUpdate(t))},handleFormUpdate(t){this.form_loading=!0,this.resetForm(),this.resetFeedback(),this.$emit("update:calling",!0),this.readStorable(t)},runBack(){this.resetForm(),this.resetFeedback(),DynamicSuite.replaceURLHistory(this.get_key_id,null),this.show_form=!1},runCreateSetup(){this.$emit("form-pre-create",!0),this.calling||(this.form_loading=!0,this.resetForm(),this.resetFeedback(),this.form_create_setup_api?(this.$emit("update:calling",!0),DynamicSuite.call(this.form_create_setup_api,this.form_create_setup_api_data,t=>{"OK"===t.status?(this.$emit("update:form",JSON.parse(JSON.stringify(Object.assign(this.form,t.data)))),this.show_form=!0,this.form_loading=!1,this.setup=!1,this.$emit("update:calling",!1)):this.error=!0})):(this.show_form=!0,this.form_loading=!1,this.setup=!1))},runCreate(){var t;this.calling||(this.resetFeedback(),this.$emit("update:calling",!0),t=Object.assign({},this.api_form,this.form_create_api_data),DynamicSuite.call(this.form_create_api,t,t=>{switch(t.status){case"OK":this.created=!0,this[this.storable_key]=t.data,setTimeout(()=>{this.created=!1,this.form_created_to_list&&(this.setup=!1,this.show_form=!1)},1e3),this.form_loading=!0,this.readStorable(t.data),this.secureForm(),DynamicSuite.pushURLHistory(this.get_key_id,null),this.$emit("update:calling",!1);break;case"INPUT_ERROR":const e=JSON.parse(JSON.stringify(this.feedback));for(const a in e)"object"==typeof t.data&&t.data.hasOwnProperty(a)&&(e[a]=t.data[a]);this.$emit("update:feedback",e),this.$emit("update:calling",!1);break;default:this.error=!0}}))},runUpdate(){var t;this.calling||(this.resetFeedback(),this.$emit("update:calling",!0),t=Object.assign({},this.api_form,this.form_update_api_data),DynamicSuite.call(this.form_update_api,t,t=>{switch(t.status){case"OK":this.secureForm(),this.show_success_tick=!0;const e=JSON.parse(JSON.stringify(this.form));for(const i in t.data)e.hasOwnProperty(i)&&(e[i]=t.data[i]);this.$emit("update:form",e),this.$emit("update:calling",!1);break;case"INPUT_ERROR":const a=JSON.parse(JSON.stringify(this.feedback));for(const r in a)"object"==typeof t.data&&t.data.hasOwnProperty(r)&&(a[r]=t.data[r]);this.show_failure_tick=!0,this.$emit("update:feedback",a),this.$emit("update:calling",!1);break;default:this.error=!0}}))},promptDelete(){this.delete_confirm=null,this.delete_protect=null,this.show_delete_modal=!0},runCancelDelete(){this.show_delete_modal=!1},runDelete(){var t;this.calling||(this.delete_confirm=null,this.delete_protect=null,this.$emit("update:calling",!0),t=Object.assign({[this.storable_key]:this.form[this.storable_key]},this.form_delete_api_data),DynamicSuite.call(this.form_delete_api,t,t=>{switch(t.status){case"OK":this.show_delete_modal=!1,this.show_form=!1,this.resetForm(),this.resetFeedback(),DynamicSuite.replaceURLHistory(this.get_key_id,null),window.history.back(),this.$emit("update:calling",!1);break;case"DELETE_PROTECT":this.delete_protect=t.data,this.$emit("update:calling",!1);break;default:this.show_delete_modal=!1,this.error=!0}}))},setURLSavedData(){const t=new URLSearchParams(window.location.search);var e=parseInt(t.get(this.get_key_id));Number.isNaN(e)?(this.show_form=!1,this.setup=!1):(this.$emit("update:calling",!1),this.form_loading=!0,this.show_form=!0,0===e?this.runCreateSetup():this.handleFormUpdate(e))}},mounted(){this.default_form=JSON.parse(JSON.stringify(this.form)),this.setURLSavedData(),window.addEventListener("popstate",()=>{this.setURLSavedData(),this.error&&location.reload()})}});
Vue.component("aui-crud-list",{template:`<div class="aui crud-list"><div class="header"><h2><template>{{title}}</template><i v-if="!initial_read && overlay" :class="loading_icon"/></h2><div class="actions"><slot name="actions"/><aui-button v-if="show_create" :disabled="overlay" @click="$emit('show-create')"><i :class="create_icon"/></aui-button><aui-input v-if="show_filter" :placeholder="filter_placeholder" :disabled="overlay" v-model="filter" @input="runFilter"/></div></div><slot name="pre-data"/><aui-notice v-if="show_no_data_notice" :icon="no_data_icon" :text="no_data_text"/><aui-notice v-else-if="initial_read && overlay" :icon="loading_icon" :text="loading_text"/><aui-list-group v-else-if="type === 'group' && !initial_read && list_group_data.length" :list="list_group_data" @click="$emit('list-interaction', $event)"/><aui-table v-else-if="type === 'table' && !initial_read && data.length" interactive sortable :table="data" :interactive_column="storable_key" :default_columns="table_default_columns" :column_names="table_column_names" :column_format="table_column_format" :row_classes="table_row_classes" :sort.sync="sort" :storage_key="table_storage_key" :calling="calling" :page.sync="page" :total="total" :limit.sync="limit" :list_range_limit="range_limit" :disabled="overlay" @row-interaction="$emit('list-interaction', $event)" @paginate="handlePaginate"/></div>`,props:{title:{type:String,default:"CRUD List"},show_create:{type:Boolean,default:!0},create_icon:{type:String,default:"fas fa-plus"},show_filter:{type:Boolean,default:!0},filter_placeholder:{type:String,default:"Filter"},no_data_icon:{type:String,default:"fas fa-ban"},no_data_text:{type:String,default:"No data"},loading_icon:{type:String,default:"fas fa-circle-notch fa-spin"},loading_text:{type:null|String,default:"Loading..."},calling:{type:Boolean,default:!1},overlay:{type:Boolean,default:!1},type:{type:String,default:"table",validator:t=>-1!==["group","table"].indexOf(t)},storable_key:{type:String,default:"id"},group_icon_key:{type:String,default:"icon"},group_title_key:{type:String,default:"title"},group_subtext_key:{type:String,default:"subtext"},table_default_columns:{type:Array,default:()=>[]},table_column_names:{type:Object,default:()=>({})},table_column_format:{type:Object,default:()=>({})},table_row_classes:{type:Function,default:()=>({})},table_storage_key:{type:null|String,default:null},read_api:{type:null|String,default:null},read_optional_data:{type:Object,default:()=>({})},range_limit:{type:Array,default:()=>[15,25,100]},filter_delay:{type:Number,default:300},refresh_interval:{type:null|Number,default:null},get_key_limit:{type:String,default:"limit"},get_key_page:{type:String,default:"page"},get_key_filter:{type:String,default:"filter"},get_key_sort:{type:String,default:"sort"}},data(){return{initial_read:!0,limit:0,total:0,page:1,filter:null,filter_timer:null,sort:{},data:[]}},computed:{show_no_data_notice(){return!this.calling&&("group"===this.type&&!this.list_group_data.length||"table"===this.type&&!this.data.length)},list_group_data(){const t=[];for(const e of this.data)e.hasOwnProperty(this.group_title_key)?t.push({icon:e.hasOwnProperty(this.group_icon_key)?e[this.group_icon_key]:"",title:e[this.group_title_key],subtext:e.hasOwnProperty(this.group_subtext_key)?e[this.group_subtext_key]:"",value:e.hasOwnProperty(this.storable_key)?e[this.storable_key]:null}):console.error("AUI CRUD list group data missing group title key");return t}},watch:{sort(){let t="";if(Object.keys(this.sort).length){for(const i in this.sort)t+=`${i}.${this.sort[i]}~`;t=t.slice(0,-1)}const e=new URLSearchParams(window.location.search);e.has(this.get_key_sort)&&e.get(this.get_key_sort)===t||(e.has(this.get_key_sort)&&!t?DynamicSuite.replaceURLHistory(this.get_key_sort,null):t&&DynamicSuite.replaceURLHistory(this.get_key_sort,t),this.readList())},limit(){const t=new URLSearchParams(window.location.search);t.has(this.get_key_limit)&&parseInt(t.get(this.get_key_limit))===this.limit||(t.has(this.get_key_limit)&&this.limit===this.range_limit[0]?DynamicSuite.replaceURLHistory(this.get_key_limit,null):this.limit!==this.range_limit[0]&&DynamicSuite.replaceURLHistory(this.get_key_limit,this.limit))}},methods:{handlePaginate(){const t=new URLSearchParams(window.location.search);t.has(this.get_key_page)&&parseInt(t.get(this.get_key_page))===this.page||(t.has(this.get_key_page)&&this.page<=1?DynamicSuite.pushURLHistory(this.get_key_page,null):1<this.page&&DynamicSuite.pushURLHistory(this.get_key_page,this.page),this.readList())},readList(t=null){this.calling||(this.data.length||(this.initial_read=!0),t=Object.assign({page:this.page,limit:this.limit,filter:this.filter,sort:t??this.sort},this.read_optional_data),this.$emit("update:calling",!0),DynamicSuite.call(this.read_api,t,t=>{"OK"===t.status?(this.data=t.data.list,this.total=t.data.total,this.initial_read=!1,this.$emit("update:calling",!1)):(DynamicSuite.replaceURLHistory(this.get_key_limit,null),DynamicSuite.replaceURLHistory(this.get_key_page,null),DynamicSuite.replaceURLHistory(this.get_key_filter,null),DynamicSuite.replaceURLHistory(this.get_key_sort,null),this.$emit("error"))}))},runFilter(){clearTimeout(this.filter_timer),this.filter_timer=setTimeout(()=>{this.page=1,this.filter?DynamicSuite.replaceURLHistory(this.get_key_filter,this.filter):DynamicSuite.replaceURLHistory(this.get_key_filter,null),this.readList()},this.filter_delay)},setURLSavedData(){const t=new URLSearchParams(window.location.search);var e=parseInt(t.get(this.get_key_limit)),i=parseInt(t.get(this.get_key_page));const a=t.get(this.get_key_sort),l={};if(a)for(const r of a.split("~")){var s=r.split(".");2===s.length&&-1!==["ASC","DESC"].indexOf(s[1])&&(l[s[0]]=s[1])}this.limit=0<e?e:this.range_limit[0],this.page=0<i?i:1,this.filter=t.get(this.get_key_filter),this.$set(this,"sort",l)}},mounted(){this.setURLSavedData(),this.readList(),this.refresh_interval&&setInterval(()=>{this.readList()},1e3*this.refresh_interval),window.addEventListener("popstate",()=>{this.setURLSavedData(),this.readList()}),DynamicSuite.listen("aui-table-clear-sort",()=>{this.sort={},DynamicSuite.replaceURLHistory("sort",null),this.readList()})}});
Vue.component("aui-form-control",{template:`<div class="aui form-control" :class="container_classes"><slot name="label"></slot><label v-if="can_have_caps" class="standard-container"><span v-if="label" class="label" v-html="label"/><span class="cap-container"><span v-if="leading_cap" class="leading-cap" v-html="leading_cap" @click="$emit('leading-cap-click')"/><span v-if="trailing_cap" class="trailing-cap" v-html="trailing_cap" @click="$emit('trailing-cap-click')"/><slot/></span></label> <label v-if="has_pseudo" class="pseudo-container"><slot/><span v-if="has_pseudo" class="pseudo"/><span v-if="label" class="label" v-html="label"/></label> <label v-if="is_wysiwyg && label" class="label" v-html="label"/><slot v-if="is_wysiwyg"/><slot v-if="is_slider"></slot><span v-if="subtext_value" class="subtext">{{subtext_value}}</span></div>`,props:{parent:{type:String,required:!0,validator(e){return-1!==["checkbox","input","radio","select","textarea","toggle","wysiwyg","slider","range"].indexOf(e)}},label:{type:null|String,required:!1,default:null},leading_cap:{type:null|String,default:null},trailing_cap:{type:null|String,default:null},success:{type:null|String,default:null},failure:{type:null|String,default:null},subtext:{type:null|String,default:null},no_feedback_icon:{type:Boolean,default:!1}},computed:{has_pseudo(){return"checkbox"===this.parent||"radio"===this.parent||"toggle"===this.parent},can_have_caps(){return"input"===this.parent||"select"===this.parent||"textarea"===this.parent},is_wysiwyg(){return"wysiwyg"===this.parent},is_slider(){return"slider"===this.parent||"range"===this.parent},container_classes(){return{[this.parent]:!0,success:!!this.success,failure:!!this.failure,"no-feedback-icon":this.no_feedback_icon}},subtext_value(){return"string"==typeof this.success?this.success:"string"==typeof this.failure?this.failure:this.subtext}},watch:{failure(){clearTimeout(window.aui_form_control_failure_timeout),window.aui_form_control_failure_timeout=setTimeout(()=>{const e=document.querySelectorAll(".aui.form-control.failure")[0];var l;e&&(l=e.getBoundingClientRect(),window.scrollBy({top:l.top-l.height-100,behavior:"smooth"}))},99)}}});
Vue.component("aui-input",{template:`<aui-form-control v-bind="properties" @leading-cap-click="$emit('leading-cap-click')" @trailing-cap-click="$emit('trailing-cap-click')"><input ref="input" :value="value" :type="type" :list="unique_id" :autocomplete="autocomplete" :autocapitalize="autocapitalize" :placeholder="placeholder" :tabindex="tabindex" :disabled="disabled" :step="step" @focus="$emit('focus', $event.target)" @blur="$emit('blur', $event.target)" @change="$emit('change', $event.target)" @input="handleInput($event.target.value)" @keydown="$emit('keydown', $event)"/><datalist v-if="!!options.length && array_options" :id="unique_id"><option v-for="(value, key) in options" :key="'option-' + key" :value="value"/></datalist><datalist v-if="!array_options && !!Object.keys(options).length" :id="unique_id"><option v-for="(value, key) in options" :key="'option-' + key" :value="key">{{value}}</option></datalist></aui-form-control>`,props:{label:{type:null|String,default:null},leading_cap:{type:null|String,default:null},trailing_cap:{type:null|String,default:null},value:{type:String|Number|Boolean|null,default:null},type:{type:String,default:"text",validator(e){return-1!==["color","date","datetime-local","email","file","number","password","range","search","tel","text","time","url","week"].indexOf(e)}},autocomplete:{type:null|String,default:null},autocapitalize:{type:null|String,default:null},placeholder:{type:null|String,default:null},disabled:{type:Boolean,default:!1},options:{type:Array|Object,default:()=>[]},tabindex:{type:String|Number|null,default:null},step:{type:String|Number|null,default:null},max_whole_digits:{type:String|Number|null,default:null},max_decimal_digits:{type:String|Number|null,default:null},success:{type:null|String,default:null},failure:{type:null|String,default:null},subtext:{type:null|String,default:null},no_feedback_icon:{type:Boolean,default:!1}},computed:{properties(){return{parent:"input",label:this.$slots.default||this.label,leading_cap:this.leading_cap,trailing_cap:this.trailing_cap,success:this.success,failure:this.failure,subtext:this.subtext,no_feedback_icon:this.no_feedback_icon}},unique_id(){return`aui-input-${this._uid}`},array_options(){return Array.isArray(this.options)}},methods:{focus(){this.$refs.input.focus()},select(){this.$refs.input.select()},handleInput(t){if("tel"===this.type){var l=t.replace(/\D/g,"").match(/(\d{0,3})(\d{0,3})(\d{0,4})/);t=l[2]?"("+l[1]+") "+l[2]+(l[3]?"-"+l[3]:""):l[1],this.$refs.input.value=t}else if("number"===this.type&&""!==t){t=t.replace("e","");l=(t=0===this.max_decimal_digits?t.replace(".",""):t).includes(".");const i=t.split(".");let e="";e=0<this.max_whole_digits&&i[0].length>this.max_whole_digits?i[0].slice(0,-1):i[0],0<this.max_decimal_digits&&l&&i[1].length>this.max_decimal_digits?e+="."+i[1].slice(0,-1):0!==this.max_decimal_digits&&void 0!==i[1]&&(e+="."+i[1]),e&&(t=e),this.$refs.input.value=t,t=Number(t)}this.$emit("input",t)}}});
...
Vue.component("aui-table",{template:`<div class="aui table"><aui-modal :show.sync="show_columns_modal" title="Select Columns To View"><template #content><aui-checkbox v-for="(selected, column) in columns_modal_model" :key="'column' + column" :label="columnName(column)" :checked="selected" v-model="columns_modal_model[column]"/><aui-alert v-if="columns_modal_feedback" type="failure" :text="columns_modal_feedback"/></template><template #left><aui-button type="secondary" text="Cancel" @click="hideColumnsModal"/></template><template #right><div class="btn-group"><aui-button text="Apply" @click="applyColumns"/><aui-button-drop :dropdown="{reset: 'Reset to Default'}" relative_to=".modal" @reset="handleResetTable"/></div></template></aui-modal><div class="table-container"><table :class="table_classes"><thead><tr><th v-for="(column, id) in columns" :key="'header' + id" ref="header" :class="columnClass(column)" @mousedown.self="runSort(column)" @dblclick="handleResetColumn($event, id)">{{columnName(column)}} <i v-if="sortable" :class="sortIcon(column)" @mousedown.self="runSort(column)"/><div v-if="interactive" @mousedown="handleResizeColumn($event, id)" @dblclick.self="handleResetColumn($event, id)"/></th></tr></thead><tbody><tr v-for="(row, id) in filtered_table" :key="'row' + id" :class="row_classes(table[id])" @click="rowInteraction(id)"><td v-for="(column_value, column) in row" :key="'column' + column + id" :class="columnClass(column)">{{columnValue(column, column_value)}}</td></tr></tbody></table></div><div v-if="interactive" class="options"><aui-pagination :disabled="disabled" :page="page" :total="total" :limit="limit" :list_range_limit="list_range_limit" @update:page="$emit('update:page', $event)" @update:limit="$emit('update:limit', $event)" @paginate="$emit('paginate')"/><aui-button type="none" title="Select Columns To View" @click="showColumnsModal"><i class="fas fa-cog"/></aui-button></div></div>`,props:{table:{type:Array,default:()=>[]},interactive:{type:Boolean,default:!1},interactive_column:{type:null|String,default:null},default_columns:{type:Array,default:()=>[]},disabled:{type:Boolean,default:!1},column_names:{type:Object,default:()=>({})},column_format:{type:Object,default:()=>({})},row_classes:{type:Function,default:()=>({})},limit:{type:null|Number,default:null},list_range_limit:{type:null|Array,default:null},page:{type:null|Number,default:null},sortable:{type:Boolean,default:!1},sort:{type:Object,default:()=>({})},sort_icon_none:{type:String,default:"fas fa-sort"},sort_icon_asc:{type:String,default:"fas fa-sort-amount-down-alt"},sort_icon_desc:{type:String,default:"fas fa-sort-amount-down"},storage_key:{type:null|String,default:null},total:{type:null|Number,default:null},calling:{type:Boolean,default:!1}},data(){return{columns:[],show_columns_modal:!1,columns_modal_model:{},columns_modal_feedback:null}},computed:{table_classes(){return{interactive:this.interactive,sortable:this.sortable}},available_columns(){return"object"!=typeof this.table[0]?[]:Object.keys(this.table[0])},filtered_table(){const t=[];for(const e in this.table){t[e]={};for(const l of this.columns)t[e][l]=this.table[e][l]}return t}},watch:{default_columns(){this.resetColumns()}},methods:{columnClass(t){return"aui-table-col-"+t.replace("_","-")},columnName(t){return this.column_names.hasOwnProperty(t)?this.column_names[t]:t},columnValue(t,e){return this.column_format.hasOwnProperty(t)?this.column_format[t](e):e},sortIcon(t){return{[this.sort_icon_none]:!this.sort.hasOwnProperty(t),[this.sort_icon_asc]:this.sort.hasOwnProperty(t)&&"ASC"===this.sort[t],[this.sort_icon_desc]:this.sort.hasOwnProperty(t)&&"DESC"===this.sort[t]}},runSort(e){if(this.sortable&&!this.calling){let t=JSON.parse(JSON.stringify(this.sort));"object"!=typeof t&&(t={}),t.hasOwnProperty(e)?"ASC"===t[e]?t[e]="DESC":delete t[e]:t[e]="ASC",this.$emit("update:sort",t)}},rowInteraction(t){this.interactive&&!this.calling&&this.interactive_column&&this.table[t].hasOwnProperty(this.interactive_column)&&this.$emit("row-interaction",this.table[t][this.interactive_column])},handleResizeColumn(t,e){let l=!0;const o=t.pageX,s=parseInt(window.getComputedStyle(this.$refs.header[e]).width);document.addEventListener("mousemove",t=>{l&&(t=s+(t.pageX-o),this.$refs.header[e].style.minWidth=`${t}px`)}),document.addEventListener("mouseup",()=>{l=!1})},handleResetColumn(t,e){this.$refs.header[e].style.minWidth=""},handleResetTable(){DynamicSuite.readURLParam("sort")&&DynamicSuite.pushURLHistory("sort",null),this.resetColumns()},resetColumns(){this.default_columns.length?this.columns=this.default_columns:this.columns=JSON.parse(JSON.stringify(this.available_columns)),this.show_columns_modal=!1,this.storage_key&&localStorage.removeItem(this.storage_key),this.$root.$emit("aui-table-reset")},showColumnsModal(){if(!this.calling){const t={};for(const e of this.available_columns)t[e]=-1!==this.columns.indexOf(e);this.$set(this,"columns_modal_model",t),this.columns_modal_feedback=!1,this.show_columns_modal=!0}},hideColumnsModal(){this.show_columns_modal=!1},applyColumns(){const t=[];for(const e in this.columns_modal_model)this.columns_modal_model[e]&&t.push(e);t.length?(this.$set(this,"columns",t),this.saveLayout(),this.hideColumnsModal()):this.columns_modal_feedback="Must select at least 1 column"},saveLayout(){this.storage_key&&(localStorage.setItem(this.storage_key,JSON.stringify(this.columns)),this.$root.$emit("aui-table-save",this.columns))},getSavedLayout(){if(!this.storage_key)return!1;let t=null,e=DynamicSuite.readCustomData("aui_table");return t=e&&e.hasOwnProperty(this.storage_key)?e[this.storage_key]:localStorage.getItem(this.storage_key),!!t&&JSON.parse(t)}},mounted(){var e=this.getSavedLayout();if(e){let t=!0;for(const l of e)-1===this.available_columns.indexOf(l)&&(t=!1);t?this.$set(this,"columns",e):this.resetColumns()}else this.resetColumns()}});
...
Vue.component("aui-textarea",{template:`<aui-form-control v-bind="properties"><textarea ref="textarea" :value="value" :placeholder="placeholder" :autocomplete="autocomplete" :disabled="disabled" :rows="rows" @focus="$emit('focus', $event.target)" @blur="$emit('blur', $event.target)" @input="$emit('input', $event.target.value)" @keydown="$emit('keydown', $event)"/></aui-form-control>`,props:{label:{type:null|String,default:null},leading_cap:{type:null|String,default:null},trailing_cap:{type:null|String,default:null},value:{type:String|Number|Boolean|null,default:null},autocomplete:{type:null|String,default:null},placeholder:{type:null|String,default:null},disabled:{type:Boolean,default:!1},rows:{type:String|Number|null,default:null},success:{type:null|String,default:null},failure:{type:null|String,default:null},subtext:{type:null|String,default:null}},computed:{properties(){return{parent:"textarea",label:this.$slots.default||this.label,leading_cap:this.leading_cap,trailing_cap:this.trailing_cap,success:this.success,failure:this.failure,subtext:this.subtext}}},methods:{focus(){this.$refs.textarea.focus()},select(){this.$refs.textarea.select()}}});

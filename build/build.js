...
// Write JS
fs.writeFileSync(path.normalize('../client/js/aui.min.js'), output_js);

// Write CSS
fs.writeFileSync(path.normalize('../client/css/aui.min.css'), output_css);
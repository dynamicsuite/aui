...
Vue.component("aui-radio",{template:'<label class="aui radio"><slot>{{label}}</slot><input type="radio" :name="group" :value="data" @change="$emit(\'input\', $event.target.value)"><span class="bubble"></span></label>',props:{label:{type:String},group:{type:String,required:!0},data:{type:String|Number|Boolean}}});

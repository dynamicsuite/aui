/*
  ...
  License: GPLv3
*/
Vue.component("aui-alert",{template:'<div v-if="show" class="aui alert" :class="style_class"><div><h3 v-if="title">{{title}}</h3><slot>{{text}}</slot></div><i v-if="closeable" class="fa fa-times close" @click="handleClose"></i></div>',props:{type:{type:String,default:"primary",validator:e=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(e)},title:{type:String},text:{type:null|String,required:!0},show:{type:Boolean|String|null,default:!0},closeable:{type:Boolean,default:!1}},computed:{style_class(){return{[`alert-${this.type}`]:"none"!==this.type}}},methods:{handleClose(){this.$emit("update:show",!1),this.$emit("close")}}});

...
Vue.component("aui-wysiwyg",{template:'<div class="aui wysiwyg"><label>{{label}}</label><div ref="editor" :class="editor_classes"></div><div v-if="subtext_value" :class="subtext_classes">{{subtext_value}}</div></div>',props:{value:{type:String},label:{type:String},actions:{type:Array,default:()=>["bold","italic","underline","heading1","ulist","olist"]},default_paragraph_separator:{type:String,default:"p"},style_with_css:{type:Boolean,default:!0},classes:{type:Object,default:()=>({actionbar:"pell-actionbar",button:"pell-btn",content:"pell-content",selected:"pell-button-selected"})},success:{type:String|Boolean,default:!1},failure:{type:String|Boolean,default:!1},subtext:{type:String}},data:()=>({editor:null}),computed:{editor_classes(){return{"border-success":this.success,"border-failure":this.failure}},subtext_classes(){return{subtext:!0,"text-success":this.success,"text-failure":this.failure}},subtext_value(){return"string"==typeof this.success?this.success:"string"==typeof this.failure?this.failure:this.subtext}},watch:{value:function(t){this.editor.content.innerHTML!==t&&(this.editor.content.innerHTML=t)}},mounted(){this.editor=pell.init({element:this.$refs.editor,actions:this.actions,defaultParagraphSeparator:this.default_paragraph_separator,styleWithCSS:this.style_with_css,classes:this.classes,onChange:t=>{this.$emit("input",t)}}),this.value&&(this.editor.content.innerHTML=this.value)}});

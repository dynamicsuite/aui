...
Vue.component("aui-checkbox",{template:'<label class="aui checkbox" :class="classes"><slot></slot><input type="checkbox" :checked="checked" :disabled="disabled" @change="$emit(\'input\', $event.target.checked)"><span class="checkmark"></span></label>',props:{checked:{type:Boolean|Number,default:!1},disabled:{type:Boolean,default:!1}},computed:{classes(){return{disabled:this.disabled}}}});

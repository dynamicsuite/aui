...
Vue.component("aui-currency",{template:'<span class="aui currency" :class="negativeClass">{{prettyValue}}</span>',computed:{negativeClass(){return this.$slots.default[0].text>=0?"":"negative"},prettyValue(){let t=Math.abs(parseFloat(this.$slots.default[0].text)).toFixed(2);return this.$slots.default[0].text>=0?"$"+t:"-$"+t}}});

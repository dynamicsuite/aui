...
Vue.component("aui-list-group",{template:'<ul class="aui list-group"><li v-for="(row, key) in rows" :key="key" @click="row.action"><div class="text"><div class="title">{{row.title}}</div><div v-if="row.subtext" class="subtext">{{row.subtext}}</div></div><span class="icon"></span></li></ul>',props:{rows:{type:Array,required:!0,validator(t){for(let i=0;i<t.length;i++){if("string"!=typeof t[i].title)return!1;if(null!==t[i].subtext&&"string"!=typeof t[i].subtext)return!1;if("function"!=typeof t[i].action)return!1}return!0}}}});

...
Vue.component("aui-select-assignment",{template:'<div class="aui select-assignment"><div class="aui select assigned"><label><span class="label-text">Assigned</span><select multiple v-model="assigned" :disabled="disabled"><option v-for="(name, id) in $parent.form[form_key].assigned" :value="id">{{name}}</option></select></label><aui-button type="secondary" :disabled="disabled" @click="moveToUnassigned">Move to "Unassigned" list</aui-button></div><div class="aui select unassigned"><label><span class="label-text">Unassigned</span><select multiple v-model="unassigned" :disabled="disabled"><option v-for="(name, id) in $parent.form[form_key].unassigned" :value="id">{{name}}</option></select></label><aui-button type="secondary" :disabled="disabled" @click="moveToAssigned">Move to "Assigned" list</aui-button></div></div>',props:{disabled:{type:Boolean,default:!1},form_key:{type:String,required:!0}},data:()=>({assigned:[],unassigned:[]}),methods:{moveToAssigned(){this.move("unassigned","assigned")},moveToUnassigned(){this.move("assigned","unassigned")},move(e,s){this[e].forEach(i=>{for(const t in this.$parent.form[this.form_key][e])if(t===i){0===this.$parent.form[this.form_key][s].length&&this.$parent.$set(this.$parent.form[this.form_key],s,{});const i=Object.assign({},this.$parent.form[this.form_key][s]),a=Object.assign({},this.$parent.form[this.form_key][e]);i[t]=a[t],delete a[t],this.$parent.$set(this.$parent.form[this.form_key],s,i),this.$parent.$set(this.$parent.form[this.form_key],e,a),0===this.$parent.form[this.form_key][e].length&&this.$parent.$set(this.$parent.form[this.form_key],e,{})}}),this.assigned=[],this.unassigned=[]}}});

/*
  ...
  License: GPLv3
*/
Vue.component("aui-alert",{template:'<div v-if="visible" class="aui alert" :class="container_class"><div><h3 v-if="title">{{title}}</h3><p><slot></slot></p></div><i v-if="closeable" class="fa fa-times close" @click="$emit(\'close\')"></i></div>',props:{type:{type:String,default:"primary",validator:e=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(e)},title:{type:String},visible:{type:Boolean,default:!0},closeable:{type:Boolean,default:!1}},computed:{container_class(){return"none"===this.type?"":"alert-"+this.type}}});
Vue.component("aui-badge",{template:'<span class="aui badge" :class="badge_class">{{content}}</span>',props:{type:{type:String,default:"primary",validator:e=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(e)},content:{type:String|Number,required:!0}},computed:{badge_class(){return"none"===this.type?"":"badge-"+this.type}}});
Vue.component("aui-button",{template:'<button class="aui btn" :class="button_class" :disabled="is_disabled" @click="$emit(\'click\')"><span v-if="isDelayed()"><i class="fa fa-spin fa-circle-notch"></i><span v-if="has_loading_text" class="loading-text">{{loading_text}}</span><slot v-else></slot></span><slot v-else></slot></button>',props:{type:{type:String,default:"primary",validator:t=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(t)},disabled:{type:Boolean,default:!1},loading:{type:Boolean,default:!1},loading_text:{type:String,default:null}},data:()=>({show_spinner:!1,default_class:!1}),computed:{has_loading_text(){return"string"==typeof this.loading_text},is_disabled(){return this.loading||this.disabled},button_class(){return"none"===this.type?"":"btn-"+this.type}},methods:{isDelayed(){return this.loading?setTimeout(()=>{this.loading&&(this.show_spinner=!0)},100):this.show_spinner=!1,this.show_spinner}}});
Vue.component("aui-button-drop",{template:'<div class="aui btn-drop" ref="dropdown"><button class="aui btn" :class="button_classes" @click="toggle"><span v-if="$slots.default"><slot></slot></span><i :class="icon_class"></i></button><ul v-show="show_dropdown" class="dropdown" ref="menu" :class="list_classes"><li v-for="entry in dropdown" @click="runAction(entry.action)">{{entry.label}}</li></ul></div>',props:{type:{type:String,default:"primary",validator:t=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(t)},dropdown:{type:Array,required:!0,validator(t){for(let e=0;e<t.length;e++){if("string"!=typeof t[e].label)return!1;if("function"!=typeof t[e].action&&"string"!=typeof t[e].action)return!1}return!0}},icon_inactive:{type:String,default:"fas fa-caret-down"},icon_active:{type:String,default:"fas fa-caret-up"},menu_align:{style:String,default:"left",validator:t=>-1!==["left","right"].indexOf(t)}},computed:{button_classes(){let t={active:this.show_dropdown};return"none"!==this.type&&(t["btn-"+this.type]=!0),t},icon_class(){return this.show_dropdown?this.icon_active:this.icon_inactive},list_classes(){let t={top:this.anchor_top};t[this.menu_align_master]=!!this.menu_align_master,t[this.menu_align]=!this.menu_align_master}},data:()=>({show_dropdown:!1,anchor_top:!1,menu_align_master:null}),methods:{toggle(){this.show_dropdown=!this.show_dropdown,this.menu_align_master=null,this.anchor_top=!1,Vue.nextTick(()=>{this.$refs.menu.style.opacity="0";const t=this.$refs.menu.getBoundingClientRect(),e=window.innerHeight-t.bottom;window.innerWidth-t.right<0&&(this.menu_align_master="right"),e<0&&(this.anchor_top=!0),this.$refs.menu.style.opacity="1"})},outsideReset(t){this.$refs.dropdown.contains(t.target)||(this.show_dropdown=!1)},runAction(t){"function"==typeof t?t():window.open(t),this.show_dropdown=!1}},created(){window.addEventListener("click",this.outsideReset)},beforeDestroy(){window.removeEventListener("click",this.outsideReset)}});

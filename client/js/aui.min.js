...
Vue.component("aui-currency",{template:'<span class="aui currency" :class="negativeClass">{{prettyValue}}</span>',props:{value:{type:String}},computed:{negativeClass(){return this.value>=0?"":"negative"},prettyValue(){let e=Math.abs(parseFloat(this.value)).toFixed(2);return this.value>=0?"$"+e:"-$"+e}}});

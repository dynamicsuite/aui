...
Vue.component("aui-button-drop",{template:'<div class="aui btn-drop" ref="dropdown"><button class="aui btn" :class="button_classes" :disabled="is_disabled" @click="toggle"><span v-if="$slots.default"><slot></slot></span><i :class="icon_class"></i></button><ul v-show="show_dropdown" class="dropdown" ref="menu" :class="list_classes"><li v-for="entry in dropdown" @click="runAction(entry.action)">{{entry.label}}</li></ul></div>',props:{type:{type:String,default:"primary",validator:t=>-1!==["none","primary","secondary","success","warning","failure"].indexOf(t)},dropdown:{type:Array,required:!0,validator(t){for(let e=0;e<t.length;e++){if("string"!=typeof t[e].label)return!1;if("function"!=typeof t[e].action&&"string"!=typeof t[e].action)return!1}return!0}},disabled:{type:Boolean,default:!1},icon_inactive:{type:String,default:"fas fa-caret-down"},icon_active:{type:String,default:"fas fa-caret-up"},menu_align:{style:String,default:"left",validator:t=>-1!==["left","right"].indexOf(t)}},computed:{button_classes(){let t={active:this.show_dropdown};return"none"!==this.type&&(t["btn-"+this.type]=!0),t},icon_class(){return this.show_dropdown?this.icon_active:this.icon_inactive},list_classes(){return this.menu_align_master?this.menu_align_master:this.menu_align+" "+this.anchor_top?"top":"bottom"},is_disabled(){return this.loading||this.disabled}},data:()=>({show_dropdown:!1,anchor_top:!1,menu_align_master:null}),methods:{toggle(){this.show_dropdown=!this.show_dropdown,this.menu_align_master=null,this.anchor_top=!1,Vue.nextTick(()=>{this.$refs.menu.style.opacity="0";const t=this.$refs.menu.getBoundingClientRect(),e=window.innerHeight-t.bottom,o=window.innerWidth-t.right;console.log(e,o),o<0&&(console.log("right override"),this.menu_align_master="right"),e<0&&(console.log("bottom override"),this.anchor_top=!0),this.$refs.menu.style.opacity="1"})},outsideReset(t){this.$refs.dropdown.contains(t.target)||(this.show_dropdown=!1)},runAction(t){"function"==typeof t?t():window.open(t),this.show_dropdown=!1}},created(){window.addEventListener("click",this.outsideReset)},beforeDestroy(){window.removeEventListener("click",this.outsideReset)}});
